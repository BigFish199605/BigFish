...
<head>
    ...
    <link rel="stylesheet" href="${sc}/staticsource/css/fullcalendar.min.css" />
    <link rel="stylesheet" href="${sc}/staticsource/css/fullcalendar.print.css" media='print' />
...
<body data-type="widgets">
    ...
    <script src="${sc}/staticsource/js/moment.js"></script>
    <script src="${sc}/staticsource/js/amazeui.min.js"></script>
    <script src="${sc}/staticsource/js/fullcalendar.min.js"></script>
