...
<head>
    ...
    <script src="${sc}/staticsource/js/echarts.min.js"></script>
    <link rel="stylesheet" href="${sc}/staticsource/css/amazeui.min.css" />
    <link rel="stylesheet" href="${sc}/staticsource/css/amazeui.datatables.min.css" />
    <link rel="stylesheet" href="${sc}/staticsource/css/app.css">
    <script src="${sc}/staticsource/js/jquery.min.js"></script>

</head>

<body data-type="widgets">
    <script src="${sc}/staticsource/js/theme.js"></script>
    <div class="am-g tpl-g">
        <!-- 头部 -->
        <header>
            <!-- logo -->
            <div class="am-fl tpl-header-logo">
                <a href="javascript:;"><img src="${sc}/staticsource/img/logo.png" alt=""></a>
            </div>
            <!-- 右侧内容 -->
                        ...
                        <li class="am-dropdown tpl-dropdown" data-am-dropdown>
                            ...
                            <ul class="am-dropdown-content tpl-dropdown-content">
                                <li class="tpl-dropdown-menu-messages">
                                    <a href="javascript:;" class="tpl-dropdown-menu-messages-item am-cf">
                                        <div class="menu-messages-ico">
                                            <img src="${sc}/staticsource/img/user04.png" alt="">
                                        </div>
                                ...
                                <li class="tpl-dropdown-menu-messages">
                                    <a href="javascript:;" class="tpl-dropdown-menu-messages-item am-cf">
                                        <div class="menu-messages-ico">
                                            <img src="${sc}/staticsource/img/user02.png" alt="">
                                        </div>
                                        <div class="menu-messages-time">
                                            5天前
                                        </div>
                                        ...
                                        <div class="am-u-sm-9">
                                            <div class="am-form-group am-form-file">
                                                <div class="tpl-form-file-img">
                                                    <img src="${sc}/staticsource/img/a5.png" alt="">
                                                </div>
  ...
  <option value="o">Orange</option>
    ...
    <script src="${sc}/staticsource/js/amazeui.datatables.min.js"></script>
    <script src="${sc}/staticsource/js/dataTables.responsive.min.js"></script>
