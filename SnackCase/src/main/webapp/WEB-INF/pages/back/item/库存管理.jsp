			...
			<div class="am-popup-bd">
				...
				<form class="am-form tjlanmu">
					<div class="am-form-group am-cf">
						...
						<div class="you">245234523452</div>
					</div>
					<div class="am-form-group am-cf">
						<div class="zuo">库存：</div>
						<div class="you">234523452</div>
					</div>
		...
		<div class="admin-biaogelist">
			...
			<form class="am-form am-g">
				<table width="100%"
					...
					<thead>
						<tr class="am-success">
								<th class="table-check"><input type="checkbox"
									name="id" onclick="checkAll('id',this)" /></th>

								<th class="table-id">排序</th>
								<th class="table-id am-text-center" name="id">ID</th>
								<th class="table-title" name="name">商品名称</th>
								<th class="table-type" name="num">库存</th>
								<th class="table-author am-hide-sm-only" name="price">已销售金额</th>
					...
					<c:forEach items="${items}" var="u" varStatus="status">
						<tr>
							<td><input type="checkbox" name="itemid" value="${u.id}"/></td>
							
							<td class="am-text-center" value="${u.id}">${u.id}</td>
							<td class="am-text-center" value="${u.id}">${u.id}</td>
							<td value="">${u.name}</td>
								...
								<td><div class="am-btn-toolbar">
									<div class="am-btn-group am-btn-group-xs">
										...
										<button
											...
											data-am-modal="{target: '#my-popups'}" title="修改库存信息">
											<span class="am-icon-pencil-square-o"></span>
										</button>
										<!-- 用按钮的时候 弹层 后缀需要加 问好 ？#的 时候才有效 真恶心 .html?# -->
										<button type="button"
											class="am-btn am-btn-default am-btn-xs am-text-danger am-round"
											title="删除" onclick="toModule('delete/item'); ">
...
<!--[if lt IE 9]>
>>>>>>> c33920e98dd15be10e727f5c6fdfbc105bbcce8a
