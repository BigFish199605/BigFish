...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="${sc}/staticsource/css/hmstyle.css" rel="stylesheet" type="text/css"/>
		<link href="${sc}/staticsource/css/skin.css" rel="stylesheet" type="text/css" />
			...
			<div class="banner">
                      <!--轮播 -->
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								<li class="banner1"><a href="introduction"><img src="${sc}/staticsource/images/ad1.jpg" /></a></li>
								<li class="banner2"><a href="introduction"><img src="${sc}/staticsource/images/ad2.jpg" /></a></li>
								<li class="banner3"><a href="introduction"><img src="${sc}/staticsource/images/ad3.jpg" /></a></li>
								<li class="banner4"><a href="introduction"><img src="${sc}/staticsource/images/ad4.jpg" /></a></li>
				...
				<div class="shopMain" id="shopmain">
					...
					<div class="am-g am-g-fixed recommendation">
						<div class="clock am-u-sm-3" ">
							<img src="${sc}/staticsource/images/2016.png "></img>
							<p>今日<br>推荐</p>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							...
							<div class="recommendationMain one">
								<a href="introduction.html"><img src="${sc}/staticsource/images/tj.png "></img></a>
							</div>
						</div>						
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain two">
								<img src="${sc}/staticsource/images/tj1.png "></img>
							</div>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain three">
								<img src="${sc}/staticsource/images/tj2.png "></img>
							</div>
						</div>
					  ...
					  <div class="am-g am-g-fixed ">
						<div class="am-u-sm-3 ">
							...
							<div class="activityMain ">
								<img src="${sc}/staticsource/images/activity1.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>														
						...
						<div class="am-u-sm-3 ">
						  <div class="icon-sale two "></div>	
							<h4>特惠</h4>
							<div class="activityMain ">
								<img src="${sc}/staticsource/images/activity2.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>								
							</div>							
						...
						<div class="am-u-sm-3 ">
							...
							<h4>团购</h4>
							<div class="activityMain ">
								<img src="${sc}/staticsource/images/activity3.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>							
						...
						<div class="am-u-sm-3 last ">
							...
							<h4>超值</h4>
							<div class="activityMain ">
								<img src="${sc}/staticsource/images/activity.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>													
					...
					<div class="am-container ">
						<div class="shopTitle ">
							...
							<div class="today-brands ">
								<a href="introduction ">桂花糕</a>
								<a href="introduction ">奶皮酥</a>
								<a href="introduction ">栗子糕 </a>
								<a href="introduction ">马卡龙</a>
								<a href="introduction ">铜锣烧</a>
								<a href="introduction ">豌豆黄</a>
							</div>
							<span class="more ">
					...
					<div class="am-g am-g-fixed floodFour">
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							...
							<a href="# ">
								<div class="outer-con ">
                                  ...
                                  <img src="${sc}/staticsource/images/act1.png " />								
							</a>
							...
							<div class="am-u-sm-7 am-u-md-4 text-two sug">
								<div class="outer-con ">
									...
									<a href="add"><i class="am-icon-shopping-basket am-icon-md  seprate"></i></a>
								</div>
								<a href=" "><img src="${sc}/staticsource/images/2.jpg" /></a>
							</div>
							...
							<div class="am-u-sm-7 am-u-md-4 text-two">
								...
								<a href="# "><img src="${sc}/staticsource/images/1.jpg" /></a>
							</div>
						...
						<div class="am-u-sm-3 am-u-md-2 text-three big">
							...
							<a href="# "><img src="${sc}/staticsource/images/5.jpg" /></a>
						</div>
						...
						<div class="am-u-sm-3 am-u-md-2 text-three sug">
							...
							<a href="# "><img src="${sc}/staticsource/images/3.jpg" /></a>
						</div>
						...
						<div class="am-u-sm-3 am-u-md-2 text-three ">
							...
							<a href="# "><img src="${sc}/staticsource/images/4.jpg" /></a>
						</div>
                 ...
                 <div class="clear "></div>  
					...
					<div class="am-g am-g-fixed floodThree ">
						...
						<div class="am-u-sm-4 text-four">
							<a href="# ">
								<img src="${sc}/staticsource/images/6.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>								
						...
						<div class="am-u-sm-4 text-four sug">
							<a href="# ">
								<img src="${sc}/staticsource/images/7.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>
						...
						<div class="am-u-sm-6 am-u-md-3 text-five big ">
							<a href="# ">
								<img src="${sc}/staticsource/images/10.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>		
						...
						<div class="am-u-sm-6 am-u-md-3 text-five ">
							<a href="# ">
								<img src="${sc}/staticsource/images/8.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>	
						...
						<div class="am-u-sm-6 am-u-md-3 text-five sug">
							<a href="# ">
								<img src="${sc}/staticsource/images/9.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>
